...
search = af.DynestyStatic(
    ...
    name="[1]decomp__instancelens__inverse_source__nonhyper",
...
source_search2_adaptive = af.Model(
    al.Galaxy,
    redshift=redshift_source,
    pixelization=al.pix.VoronoiBrightnessImage(pixels=300, weight_floor=0.0, weight_power=1),
...
search = af.DynestyStatic(
    path_prefix=path_prefix,
    name="[2]decomp__instancelens__inverse_source__hyper",
    unique_tag=dataset_name,
    nlive=120,
    walks=8,
    dlogz=0.8
